...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 15, 2018 lúc 10:49 AM
...
--
-- Cấu trúc bảng cho bảng `buy_cards`
--
...
--
-- Đang đổ dữ liệu cho bảng `buy_cards`
--

INSERT INTO `buy_cards` (`id`, `user_id`, `card_provider_code`, `card_provider_name`, `card_discount`, `card_amount`, `card_amount_discount`, `card_qty`, `card_prices`, `card_prices_discounted`, `money_before`, `money_after`, `card_notes`, `card_info`, `card_pin`, `card_serial`, `status`, `is_deleted`, `created_at`, `updated_at`) VALUES
(263, 2, 'vtt', 'Viettel', 1, 99000, 1, 1, 100000, 0, NULL, NULL, NULL, NULL, '11111111111', '11111111', 2, 0, '2018-10-15 08:38:31', '2018-10-15 08:40:40');
...
(7719, 2, NULL, 'Trừ tiền mua thẻ, chuyển tiền vào tạm giữ: 100000', 100000, 3, 'MUA THE', 3, '2018-10-15 08:38:31', '2018-10-15 08:38:31'),
(7720, 2, NULL, 'Gửi mã thẻ thành công, trừ tiền tạm giữ: 100000', 100000, 3, 'MUA THE', 3, '2018-10-15 08:40:40', '2018-10-15 08:40:40');
...
(2, 'khanhpv', 'khanhdaik@gmail.com', '$2y$10$7oX3vjxcfh1BIDrGgd7PW.yngdCst3/CARdLDdgwkqD.AuWnPnTJe', '096868668454', NULL, 400000, NULL, 0, 1, '5gvvQcA5NMS1UWTxh8cWjuUsVhqtSGm3YcHuLvDN9bDL88uKIPbzXMuFgNWv', '2018-10-02 02:22:25', '2018-10-15 08:40:40', '123456', 0, 0, '10', 1),
...
(15, 2, 10, 'ACB', 'ha noi', 3, 'PHAM VAN KHANH', '0116464644', 190000, NULL, NULL, NULL, 3, '2018-10-14 04:45:35', '2018-10-14 04:45:35'),
(16, 2, 10, 'ACB', 'ha noi', 3, 'PHAM VAN KHANH', '0116464644', 190000, NULL, NULL, NULL, 3, '2018-10-14 04:55:10', '2018-10-14 04:55:10'),
(17, 2, 1, 'Tài khoản MoMo', 'Tran duy Hung', 6, 'PHAM VAN KHANH', '016849457115', 190000, NULL, NULL, NULL, 3, '2018-10-14 04:59:12', '2018-10-14 04:59:12');
...
--
-- AUTO_INCREMENT cho bảng `buy_cards`
--
ALTER TABLE `buy_cards`
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7721;
